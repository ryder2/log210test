...
RSpec.describe "demande_vs/new", type: :view do
  before(:each) do
    assign(:demande_vs, DemandeVs.new(
      :motif_pv => "MyString",
  ...
  it "renders new demande_vs form" do
    render

    assert_select "form[action=?][method=?]", demande_vs_index_path, "post" do
