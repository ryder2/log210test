...
RSpec.describe "vs_demandes/new", type: :view do
  before(:each) do
    assign(:vs_demande, VsDemande.new(
      :motif_pv => "MyString",
  ...
  it "renders new vs_demande form" do
    render

    assert_select "form[action=?][method=?]", vs_demandes_path, "post" do
